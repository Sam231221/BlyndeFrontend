        ...
        >
          <div className="relative h-[300px] ">
            ...
            <div className="absolute flex flex-col top-3 right-3 text-lg  transition-all duration-200 ease-in-out z-[3] translate-x-12 group-hover:translate-x-0 ">
              <Link
                to={"#"}
                className="bg-white mb-2 text-gray-400 border border-zinc-200 px-2 py-1 transition-all duration-200 ease-in-out rounded-sm hover:bg-gray-900 hover:text-white hover:border-gray-800"
              >
                <ion-icon
                  name="heart-outline"
                  role="img"
              ...
              <button className=" bg-white mb-2 text-gray-400 border border-zinc-200 px-2 py-1 transition-all duration-200 ease-in-out rounded-sm hover:bg-gray-900 hover:text-white hover:border-gray-800">
